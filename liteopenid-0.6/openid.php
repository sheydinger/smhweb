...
class LightOpenID
{
    ...
    function dump_this()
    {
file_put_contents('debug.txt', "     returnUrl=" . $this->returnUrl  . "\n", FILE_APPEND);
file_put_contents('debug.txt', "     required="  . var_export($this->required, true)   . "\n", FILE_APPEND);
file_put_contents('debug.txt', "     trustRoot="  . $this->trustRoot . "\n", FILE_APPEND);

    }

    function __construct($host)
    {
file_put_contents('debug.txt', "openid.php __construct(" . $host . ")\n", FILE_APPEND);
    ...
    {
file_put_contents('debug.txt', "openid.php __set(" . $name . ", " . $value . ")\n", FILE_APPEND);
    ...
    function __get($name)
    {
file_put_contents('debug.txt', "openid.php __get(" . $name . ")\n", FILE_APPEND);
$ret = "(unknown __get() return value)";
        ...
        case 'identity':
            ...
            $ret = $this->claimed_id;
file_put_contents('debug.txt', "openid.php    ==> " . $ret . "\n", FILE_APPEND);
            return $ret;
        case 'trustRoot':
        case 'realm':
            $ret = $this->trustRoot;
file_put_contents('debug.txt', "openid.php    ==> " . $ret . "\n", FILE_APPEND);
            return $ret;
        case 'mode':
            $ret = empty($this->data['openid_mode']) ? null : $this->data['openid_mode'];
file_put_contents('debug.txt', "openid.php    ==> " . $ret . "\n", FILE_APPEND);
            return $ret;
        }
    }
    ...
    {
file_put_contents('debug.txt', "openid.php hostExist()\n", FILE_APPEND);
    ...
    {
file_put_contents('debug.txt', "openid.php request_curl()\n", FILE_APPEND);
    ...
    {
file_put_contents('debug.txt', "openid.php parse_header_array()\n", FILE_APPEND);
    ...
    {
file_put_contents('debug.txt', "openid.php request_streams()\n", FILE_APPEND);
    ...
    {
file_put_contents('debug.txt', "openid.php request()\n", FILE_APPEND);
    ...
    {
file_put_contents('debug.txt', "openid.php build_Url(" . $url . ", " . $parts . ")\n", FILE_APPEND);
    ...
    {
file_put_contents('debug.txt', "openid.php htmlTag()\n", FILE_APPEND);
    ...
    {
file_put_contents('debug.txt', "openid.php discover(" . $url . ")\n", FILE_APPEND);
                ...
                if (isset($headers['content-type'])
                    ...
                    foreach($m[1] as $content) {
                        ...
                        if(preg_match('#<Type>\s*'.$ns.'(server|signon)\s*</Type>#s', $content, $type)) {
                            ...
                            if (empty($server)) {
file_put_contents('debug.txt', "openid.php    discover() ==> false\n", FILE_APPEND);
                                return false;
                            }
                            ...
                            $this->server = $server;
file_put_contents('debug.txt', "openid.php    discover() ==> " . $server . "\n", FILE_APPEND);
                            return $server;
                        }
...
file_put_contents('debug.txt', "openid.php    discover() ==> " . $server . "\n", FILE_APPEND);
    ...
    {
file_put_contents('debug.txt', "openid.php sregParams()\n", FILE_APPEND);
    ...
    {
file_put_contents('debug.txt', "openid.php axParams()\n", FILE_APPEND);
    ...
    {
file_put_contents('debug.txt', "openid.php authUrl_v1()\n", FILE_APPEND);
    ...
    {
file_put_contents('debug.txt', "openid.php authUrl_v2()\n", FILE_APPEND);
        ...
        $temp =  $this->build_url(parse_url($this->server)
                               , array('query' => http_build_query($params, '', '&')));

file_put_contents('debug.txt', "openid.php    authUrl_v2() ==> " . $temp . "\n", FILE_APPEND);
        return $temp;
    }
    ...
    {
file_put_contents('debug.txt', "openid.php authUrl()\n", FILE_APPEND);

//file_put_contents('debug.txt', "authUrl immediate=" . $immediate . "\n", FILE_APPEND);
//file_put_contents('debug.txt', "authUrl setup_url=" . $this->setup_url . "\n", FILE_APPEND);
//file_put_contents('debug.txt', "authUrl this=" . "\n", FILE_APPEND);
//$this->dump_this();
    ...
    function validate()
    {
file_put_contents('debug.txt', "openid.php validate()\n", FILE_APPEND);
    ...
    {
file_put_contents('debug.txt', "openid.php getAxAttributes()\n", FILE_APPEND);
        $alias = null;
    ...
    {
file_put_contents('debug.txt', "openid.php getSregAttributes()\n", FILE_APPEND);
        $attributes = array();
    ...
    {
file_put_contents('debug.txt', "openid.php getAttributes()\n", FILE_APPEND);
        if (isset($this->data['openid_ns'])
