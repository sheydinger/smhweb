...
$client->setClientId('1039710745910-feoe9337d7cgcmf1g1l4db4bsqphu826.apps.googleusercontent.com');
$client->setClientSecret('Vqz_zRuerv8Ve5yQ-O1N4a0t');
$client->setRedirectUri('http://www.theunclassroom.org/smhweb/url_shorten_demo.php');
...
<div class="box">
  <div class="request">
    ...
    <?php else: ?>
      <form id="url" method="GET" action="url_shorten_demo.php">
