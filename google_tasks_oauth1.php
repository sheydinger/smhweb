...
// http://stackoverflow.com/questions/11940475/google-auth-1-0-access-gmail-unauthorized

    // The callback should probably be a page different than this one.  When Google calls
    // back there is no apparent way to determine if this page was called on its original
    // call, or if it is getting called back from Google.  In contrast, google_tasks_oauth1
    ...
    $version            = "1.0";
    $callback           = "http://www.theunclassroom.org/smhweb/google_tasks_oauth1_page2.php";
//    $scope              = "http://www.google.com/calendar/feeds http://picasaweb.google.com/data";
    ...
    $sigbase=
        ...
        "oauth_callback%3Dhttp%253A%252F%252Fwww.theunclassroom.org%252Fsmhweb%252Fgoogle_tasks_oauth1_page2.php%26" .
...
//        "scope%3Dhttp%253A%252F%252Fwww.google.com%252Fcalendar%252Ffeeds%2520http%253A%252F%252Fpicasaweb.google.com%252Fdata";
...
//    curl_setopt($ch2, CURLOPT_URL, "https://www.google.com/accounts/OAuthAuthorizeToken?oauth_token=" . $oauth_token . "&hd=default&hl=en");
