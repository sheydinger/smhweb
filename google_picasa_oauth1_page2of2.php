<?php
    ...
    // 4) https://picasaweb.google.com/data/feed/api/user/default/
    // -----------------------------------------------------------
    ...
    // even if something else is really the problem.  This is very misleading.
...
//    $verifier           = $_GET['oauth_verifier'];
    ...
    $sigbase =
        "GET&https%3A%2F%2Fpicasaweb.google.com%2Fdata%2Ffeed%2Fapi%2Fuser%2Fdefault%2F&" . // No %3D%26 after &!
        urlencode("oauth_consumer_key="     . $consumer_key     . "&") .
        urlencode("oauth_nonce="            . $nonce            . "&") .
        urlencode("oauth_signature_method=" . $signature_method . "&") .
        urlencode("oauth_timestamp="        . $timestamp        . "&") .
    ...
    curl_setopt($ch, CURLOPT_URL, "https://picasaweb.google.com/data/feed/api/user/default/");
