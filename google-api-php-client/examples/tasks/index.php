...
$client->setClientId('662159824355.apps.googleusercontent.com');
$client->setClientSecret('LaAqCTKkRMfS-auxsXxeZxCg');
$client->setRedirectUri('http://www.theunclassroom.org/smhweb/google-api-php-client/examples/tasks');
